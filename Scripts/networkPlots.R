...
edgeData<-read.delim("Data/GATK_Pipeline_Out/2010AC20099_S2_L001_R1_001.sam.edges.txt",header=TRUE)
nodeData<-read.delim("Data/GATK_Pipeline_Out/2010AC20099_S2_L001_R1_001.sam.nodes.txt",header=TRUE)

edgeData<-read.delim("Data/GATK_Pipeline_Out/2010AC19096_S21_L001_R1_001.sam.edges.txt",header=TRUE)
nodeData<-read.delim("Data/GATK_Pipeline_Out/2010AC19096_S21_L001_R1_001.sam.nodes.txt",header=TRUE)
...
#filter edges
net_filtered.sp<-delete_edges(net_filtered, E(net_filtered)[weight<1000])
...
plot(net_filtered.sp2,vertex.label.cex=.9,edge.arrow.size=.2,edge.arrow.mode=0, edge.label=E(net_filtered.sp)$weight,layout=layout.fruchterman.reingold)
plot(net_filtered.sp2,vertex.label.cex=.1,edge.arrow.size=.2,edge.arrow.mode=0, layout=layout.fruchterman.reingold)
